...
// connect database
$conn = db_connect();
$result = getAllBookByCategory($conn, $catname);
...
?>
<p class="lead"><a href="categories.php">Category</a> > <?php echo $catname; ?></p>
...
?>
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <a href="book_detail.php?bookisbn=<?php echo $row['book_isbn']; ?>" class="btn btn-primary">Get Details</a>
        </div>
    </div>
    <br>
<?php

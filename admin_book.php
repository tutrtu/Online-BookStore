...
$result = mysqli_query($conn, "SELECT * FROM books LIMIT $results_per_page OFFSET $offset");
$row = [];
			...
			?>
				<div class="col-md-3 book-container">
					<a href="book_detail.php?bookisbn=<?php echo htmlspecialchars($book['book_isbn'], ENT_QUOTES, 'UTF-8'); ?>" class="book-link">
						...
						<td><a href="admin_edit.php?bookisbn=<?php echo $book['book_isbn']; ?>"><span class="glyphicon glyphicon-edit"></span></a></td>
						<td><a href="admin_delete.php?bookisbn=<?php echo $book['book_isbn']; ?>"><span class="glyphicon glyphicon-trash"></a></td>
					</a>
				</div>
			<?php
				$count++;
